...
public class RedisUtil {
     ...
     * @param kesList
     */
    public void del(List kesList) {
        if (CollectionUtil.isNotEmpty(kesList)) {
            redisTemplate.delete(kesList);
        }
    }
    ...
    public long batchAddSet(String key, Set<ZSetOperations.TypedTuple> typles) {
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple> getKeySetRandom(String key, long start, long end) {
