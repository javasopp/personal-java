...
public class GeneratorEntity {
     ...
     * 代码生成的根路径
     */
    private static final String BASEDIR = "/Users/sopp/Desktop/auto_code";

    /**
     * 包结构的根路径
     */
    private static final String PARENT_PACKAGE = "com.sopp.all";
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.
                setUsername("root").
                setPassword("root").
                setUrl("jdbc:mysql://localhost:3307/test?useSSL=false&serverTimezone=UTC");
